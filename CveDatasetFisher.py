...
Button(master, text='Save token', command=lambda: tokenUpdater.setToken(tokenOnlineInput.get())).grid(row=3, column=7, sticky=W , padx=0,pady=4)
...
#cveCombobox = ttk.Combobox(master, value=cvesList, name='cve')
...
#cveCombobox.grid(row=2, column=10)
#cvesLb = cveCombobox
