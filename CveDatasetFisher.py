...
#Source for this tkinter line: https://www.geeksforgeeks.org/file-explorer-in-python-using-tkinter/(check)
from tkinter import  ttk
#git source: https://www.devdungeon.com/content/working-git-repositories-python (check)
from git import *
...
#Source got subprocess:https://docs.python.org/3/library/subprocess.html(check)
import subprocess
import json
#Source for ast: https://www.geeksforgeeks.org/python-convert-string-dictionary-to-dictionary/(check)
import ast

#Source for the tkinter code parts: https://www.python-kurs.eu/tkinter_entry_widgets.php , https://www.tutorialspoint.com/how-to-make-the-tkinter-text-widget-read-only, https://pythonassets.com/posts/drop-down-list-combobox-in-tk-tkinter/,https://www.geeksforgeeks.org/file-explorer-in-python-using-tkinter/
#Source for file operations:https://www.w3schools.com/python/python_file_handling.asp(check)
...
#6 input entries; Source:https://www.python-kurs.eu/tkinter_entry_widgets.php 
