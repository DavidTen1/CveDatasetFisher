...
#Sources for the tkinter import: https://www.geeksforgeeks.org/file-explorer-in-python-using-tkinter/
from tkinter import *
...
def isURLOnline(value):# Source leading to this code: https://github.com/pedrojunqueira/PytalistaYT/blob/master/Python/requests/download_files.py
...
def doesFileExist(value):
    ...
    """
    #Source for os.path.isfile(value): https://www.freecodecamp.org/news/how-to-check-if-a-file-exists-in-python/
